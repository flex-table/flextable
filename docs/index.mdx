---
title: Introduction
description: FlexTable is a fast, native desktop client for PostgreSQL, MySQL, MariaDB, SQL Server, Oracle, CockroachDB, Amazon Redshift, ClickHouse, SQLite, MongoDB, and Redis.
---
...
<Note>
**Want one sooner?** Tell us which engine you need and we will prioritize it. [Open a feature request](https://github.com/flex-table/flextable/issues/new?template=feature_request.yml) or [ask on Discord](https://discord.gg/EhmRcCq4N).
</Note>
